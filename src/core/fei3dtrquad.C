...
void
FEI3dTrQuad :: local2global(Coordinates &answer, const FloatArray &lcoords, const FEICellGeometry &cellgeo) const
{
    FloatArray n;
...
int
FEI3dTrQuad :: global2local(FloatArray &answer, const Coordinates &gcoords, const FEICellGeometry &cellgeo) const
{
...
void
FEI3dTrQuad :: edgeLocal2global(Coordinates &answer, int iedge,
                                const FloatArray &lcoords, const FEICellGeometry &cellgeo) const
{
    FloatArray N;
...
void
FEI3dTrQuad :: surfaceLocal2global(Coordinates &answer, int isurf,
                                   const FloatArray &lcoords, const FEICellGeometry &cellgeo) const
{
