...
public:
     ...
     */
    virtual int instanciateYourself(DataReader &dr, const std::shared_ptr<InputRecord_>& irPtr, InputFieldType ift, const std::string& name, DataReader::InputRecordType irType)
    {
        // read modules
